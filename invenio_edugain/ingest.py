...
class IdPDataImportItem:
    ...
    added_idp_ids: list[str] = dataclasses.field(default_factory=list)
    unchanged_idp_ids: list[str] = dataclasses.field(default_factory=list)
    updated_idp_ids: list[str] = dataclasses.field(default_factory=list)
